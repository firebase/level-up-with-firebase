...
namespace Hamster.MapObjects {
  ...
  public class SwitchableSpikesTile : MapObject, ISwitchable {
    ...
    // Default/Label
    public const string SpikesTileForceKey ="spikes_tile_force";
    public const float SpikesTileForceDefault= 10.0f;
    public const string SpikesTileRadiusKey ="spikes_tile_radius";
    public const float SpikesTileRadiusDefault= 1.0f;
    public const string SpikesTileUpwardsModKey ="spikes_tile_upwards_mod";
    public const float SpikesTileUpwardsModDefault= -0.5f;
    ...
    private void Start() {
      ExplosionForce = SpikesTileForceDefault;
      ExplosionRadius = SpikesTileRadiusDefault;
      ExplosionUpwardsModifier = SpikesTileUpwardsModDefault;
