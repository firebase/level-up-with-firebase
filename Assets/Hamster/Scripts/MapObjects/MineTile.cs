...
namespace Hamster.MapObjects {
  ...
  public class MineTile : MapObject {
    ...
    // Default/Label
    public const string MineTileForceKey ="mine_tile_force";
    public const float MineTileForceDefault=10.0f;
    public const string MineTileRadiusKey ="mine_tile_radius";
    public const float MineTileRadiusDefault=2.0f;
    public const string MineTileUpwardsModKey ="mine_tile_upwards_mod";
    public const float MineTileUpwardsModDefault= 0.2f;
    ...
    private void Start() {
      ExplosionForce = MineTileForceDefault;
      ExplosionRadius =  MineTileRadiusDefault;
      UpwardsModifier = MineTileUpwardsModDefault;
    }
