...
namespace Hamster.Menus {
  ...
  // elements in a long text dialog.  Long text dialogs are
  // designed to display scroll boxes with large amounts of text.
  public class LongTextDialogGUI : BaseMenu {
